...
public enum RTSATTHandling: Sendable {
    case managedByLibrary
    case managedByHost(signal: RTSATTSignal)
    case skip
}

public final class RTSATTSignal: @unchecked Sendable {
...
public final class RTSSplashSignal: @unchecked Sendable {
...
public typealias RTSSplashProvider    = (_ onComplete: @escaping () -> Void) -> AnyView
public typealias RTSMainViewProvider  = () -> AnyView
public typealias RTSAppsFlyerIDProvider = () -> String?

public enum RTSLaunchMode: Sendable {
    case simple
    case full(registerURL: String, syncURL: String, bundleID: String)
}

public struct RTSConfiguration: @unchecked Sendable {

    public let launchMode:          RTSLaunchMode
    public let registerURL:         String
    public let syncURL:             String
    public let bundleID:            String
    public let attHandling:         RTSATTHandling
    public let attDelay:            TimeInterval
    public let appsFlyerIDProvider: RTSAppsFlyerIDProvider?
    public let pushEnabled:         Bool
    public let fallbackURL:         String?
    public let splashProvider:      RTSSplashProvider?
    public let debugMode:           RTSDebugMode
    ...
    public init(
        ...
        attHandling:         RTSATTHandling              = .skip,
    ...
    public init(
        ...
        syncURL:             String,
        bundleID:            String,
        attSignal:           RTSATTSignal,
        appsFlyerIDProvider: @escaping RTSAppsFlyerIDProvider,
        attDelay:            TimeInterval                = 0.5,
        splash:              RTSSplashProvider?          = nil,
        debugMode:           RTSDebugMode               = .disabled,
        pushEnabled:         Bool                       = true,
