...
struct RTSWebView: UIViewRepresentable {

    let urlString: String
    @ObservedObject var navState: RTSNavigationState
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        if let url = URL(string: urlString) {
            ...
            RTSLogger.log(.debug, "WebView: load \(urlString)")
        } else {
            RTSLogger.log(.error, "WebView: invalid URL — \(urlString)")
        }
    ...
    final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
        ...
        func webView(_ webView: WKWebView, didStartProvisionalNavigation navigation: WKNavigation!) {
            ...
            RTSLogger.log(.debug, "WebView: didStart — \(webView.url?.absoluteString ?? "")")
        }
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            ...
            updateNavButtons(webView)
            RTSLogger.log(.debug, "WebView: didFinish — \(webView.url?.absoluteString ?? "")")
        }
        ...
        func webViewWebContentProcessDidTerminate(_ webView: WKWebView) {
            RTSLogger.log(.warning, "WebView: process terminated — reload")
        ...
        private func handleError(_ error: Error, webView: WKWebView) {
            ...
            RTSLogger.log(.error, "WebView: error — \(error.localizedDescription)")
